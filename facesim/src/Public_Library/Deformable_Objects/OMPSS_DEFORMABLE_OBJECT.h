...
//#####################################################################
    ...
    void CG_Helper_I(int p, T beta);
    void CG_Helper_II(int p, double& S_dot_Q, T time);
    void CG_Helper_III(int p, ARRAY<TV>& dX,double& rho_new, double& supnorm, double rho, double S_dot_Q);
    ...
    void Force_Differential_Internal (const ARRAY<TV>& dX, ARRAY<TV>& dF, const int partition_id) const;
    void Force_Differential_External (const ARRAY<TV>& dX, ARRAY<TV>& dF, const int partition_id) const;
