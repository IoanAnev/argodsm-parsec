...
//Body tracking threaded with OMPSS
#if defined(USE_OMPSS)
		...
		case 0 : 
			...
			break;
                ...
                case 2 :
								...
								case 4 : 
									#if defined(USE_OMPSS)
										mainOMPSS(path, cameras, frames, particles, layers, threads, OutputBMP);			//OpenMP threaded tracking
										break;
									#else
										cout << "Not compiled with OmpSs support. " << endl;
										cout << "If the environment supports OmpSs, rebuild with USE_OMPSS #defined." << endl;
										break;
									#endif
